                ...
                <div class="flex items-center justify-center h-16">
                    <div class="flex items-center">
                        ...
                        <div class="ml-10 flex-shrink-0">
                            <svg class="h-10 w-auto" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
                                xmlns="http://www.w3.org/2000/svg" height="80" width="272" version="1.1"
                                viewBox="0 0 272 80">
                                <defs>
                                    <linearGradient id="a" x1="156" gradientUnits="userSpaceOnUse"
                                        y1="325" gradientTransform="matrix(.403 0 0 .403 -21.8 -51)"
                                        x2="151" y2="120">
