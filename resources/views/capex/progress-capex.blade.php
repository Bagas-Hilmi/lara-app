        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-primary" style="background-color: #09170a; border-color: #09170a;" id="new-progress-btn" data-bs-toggle="modal" data-bs-target="#new-progress-modal">
...
<<script>
    $(document).ready(function() {
        ...
        $('#progress-modal').on('hidden.bs.modal', function () {
            $('#progress-table').DataTable().clear().destroy(); // Membersihkan DataTable ketika modal ditutup
        });
    });
</script>
