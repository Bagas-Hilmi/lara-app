<div class="dropdown dropdown-1">
    ...
    <ul class="dropdown-menu" aria-labelledby="actionDropdown_{{ $row->id }}">
        @if ($row->status_capex == 'Canceled' || $row->status_capex == 'To Opex' || $row->status_capex == 'On Progress' || $row->status_capex == 'Waiting Approval' || $row->status_capex == 'Approval Completed' )
        <li>
